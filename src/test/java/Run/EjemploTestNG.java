	...
	public void Ingresar_Direccion(String Ejecutar, String Evidencia, String Usuario, String Contrasena,String Documento,String Usuario1)
		...
		if (Ejecutar.equals("SI")) {
			...
			if (Evidencia.equals("SI")) {
				...
				//selecObject.ValidacionesCertificado_588065(Evidencia,  rutaCarpeta);
				//selecObject.ValidacionesLogueado_587966(Evidencia, Usuario, Contrasena, rutaCarpeta);
				
				//selecObject.ValidacionesSimuladores_588077(Evidencia, rutaCarpeta);
				
				selecObject.ValidacionesCertificados_589706(Evidencia, rutaCarpeta);
				//ValidacionesCertificados
